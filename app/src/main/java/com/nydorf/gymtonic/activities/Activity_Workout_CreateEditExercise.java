...
public class Activity_Workout_CreateEditExercise extends AppCompatActivity
        implements Adapter_Workout_Routine.Interface_Workout_Routine, Adapter_Workout_Plans.Interface_Workout_Plans {

    /**
     * This activity lets the user create or edit exercises. Changes will be saved
     * to the database.
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewPlans.setLayoutManager(
                new LinearLayoutManager(getApplicationContext(), LinearLayoutManager.HORIZONTAL, false));
