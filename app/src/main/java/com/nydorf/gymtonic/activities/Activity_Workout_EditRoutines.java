...
public class Activity_Workout_EditRoutines extends AppCompatActivity
        implements Adapter_Item_General_001.Interface_Item_Edit, AdapterView.OnItemSelectedListener {

    /**
     * This activity lets the user edit workout routines. Changes will be saved to
     * the database.
     *
     * - This activity is for changing values of an existing routines only. Creating
     * new routines
    ...
    private void showDialogEditRoutineName(String currentRoutineName, int itemPosition) {
        ...
        builder.setPositiveButton(getResources().getString(R.string.button_text_save),
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        databaseHelper.updateWorkoutRoutineName(workoutPlans[selectedPlanIdx], currentRoutineName,
                                newRoutineName);
    ...
    private void showDialogCreateRoutine() {
        ...
        builder.setNegativeButton(getResources().getString(R.string.button_text_cancel), null);
        builder.setPositiveButton(getResources().getString(R.string.button_create_routines),
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter adapterPlans = new ArrayAdapter(getApplicationContext(), R.layout.spinner_item_purple_middle,
                workoutPlans);
