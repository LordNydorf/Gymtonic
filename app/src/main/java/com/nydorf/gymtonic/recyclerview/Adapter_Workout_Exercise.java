...
public class Adapter_Workout_Exercise extends RecyclerView.Adapter<Adapter_Workout_Exercise.Viewholder> {
    ...
    /*
     * Adapter for RecyclerView in Fragment_Exercises. Used to display
     * Item_Exercise.
     */
    ...
    public Adapter_Workout_Exercise(List<Item_Workout_Exercise> exerciseList,
            Interface_Workout_Exercises interfaceWorkoutExercises) {
