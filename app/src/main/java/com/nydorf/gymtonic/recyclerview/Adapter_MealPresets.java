...
public class Adapter_MealPresets extends RecyclerView.Adapter<Adapter_MealPresets.Viewholder> {
    ...
    /*
     * Adapter for RecyclerView in Activity_AddMeal. Used to display
     * Item_MealPreset.
     */
    ...
    public Adapter_MealPresets(List<Item_MealPreset> mealPresetsList, mealPresetItemInterface itemInterface,
            Context context) {
    ...
    public void onBindViewHolder(@NonNull Viewholder holder, int position) {
        ...
        holder.buttonAdd.setOnClickListener(view -> {
            ...
            holder.itemInterface.updateItemAmount(holder.getAdapterPosition(), mealPreset.getMealUUID(),
                    mealPreset.getAmount());
        });
